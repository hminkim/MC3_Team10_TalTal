...
fileprivate let beginnerDailyMissions: [Mission] = [
...
fileprivate let intermediateDailyMissions: [Mission] = [
...
fileprivate let advancedDailyMissions: [Mission] = [
...
fileprivate let beginnerWeeklyMissions: [Mission] = [
...
fileprivate let intermediateWeeklyMissions: [Mission] = [
...
fileprivate let advancedWeeklyMissions: [Mission] = [
