...
let beginnerDailyMissions: [Mission] = [
...
let intermediateDailyMissions: [Mission] = [
...
let advancedDailyMissions: [Mission] = [
...
let beginnerWeeklyMissions: [Mission] = [
...
let intermediateWeeklyMissions: [Mission] = [
...
let advancedWeeklyMissions: [Mission] = [
